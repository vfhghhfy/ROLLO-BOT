...
const smsUnreg = () => { return `\`\`\`〔لحظة !! انت لست مسجل〕*\n\n*〔سجل الامر لكي يتم تفعيله〕\n➣ #تفعيل\`\`\`` }
...
//main.js
const smsWelcome = () => { return `*╭┈⊰* 🚀الــتــرحــيــب🚀 *⊰┈ ✦*\n*┊˹📯˼┊ اهــلا بــك*\n┊˹🥷🏻˼┊ @user\n┊📩 *اقرأ وصف المجموعة*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n> *منور الجروب يا قلب بويكا ┊˹✅˼┊*`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *تغور ياجي مكانك طابور 👋🏻🐦*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*[ 📯 ] @user تمت ترقيتك إلى مشرف.*'}
...
const smsSrevoke = () => { return '*[ 📯 ] تمت إعادة تعيين رابط دعوة المجموعة.*'}
